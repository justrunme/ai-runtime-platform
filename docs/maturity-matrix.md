...
| HA closed-loop e2e | Supported | Nightly: 2 CP (Postgres) + 2 Runtime + Redis + OIDC |
...
| Platform combined e2e | Supported | mock CP (PR) + OIDC + real CP (release/nightly) + HA nightly |
